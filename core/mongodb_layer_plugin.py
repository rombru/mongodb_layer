...
class MongoDBLayerPlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MongoDBLayerPlugin_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MongoDBLayer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/mongodb_layer/icon.png'
        self.add_action(
            icon_path,
    ...
    def onClosePlugin(self):
        ...
        #print "** CLOSING MongoDBLayerPlugin"
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING MongoDBLayerPlugin"
